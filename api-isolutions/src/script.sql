...
ALTER TABLE t_isl_avamec
    ADD CONSTRAINT fk_t_isl_id_avaliacao FOREIGN KEY ( t_isl_id_avaliacao )
        REFERENCES t_isl_avaliacao ( id_avaliacao )ON DELETE CASCADE;

ALTER TABLE t_isl_veiculo
    ADD CONSTRAINT fk_t_isl_id_cliente FOREIGN KEY ( id_cliente )
        REFERENCES t_isl_cliente ( id_cliente )ON DELETE CASCADE;

ALTER TABLE t_isl_veiculo
    ADD CONSTRAINT fk_t_isl_id_marca FOREIGN KEY ( id_marca )
        REFERENCES t_isl_marca ( id_marca )ON DELETE CASCADE;

ALTER TABLE t_isl_avamec
    ADD CONSTRAINT fk_t_isl_id_mecanica FOREIGN KEY ( t_isl_id_mecanica )
        REFERENCES t_isl_mecanica ( id_mecanica )ON DELETE CASCADE;
...
ALTER TABLE t_isl_servpeca
    ADD CONSTRAINT fk_t_isl_id_peca FOREIGN KEY ( t_isl_id_peca )
        REFERENCES t_isl_peca ( id_peca )ON DELETE CASCADE;

ALTER TABLE t_isl_servpeca
    ADD CONSTRAINT fk_t_isl_id_servico FOREIGN KEY ( t_isl_id_servico )
        REFERENCES t_isl_servico ( id_servico )ON DELETE CASCADE;
...
ALTER TABLE t_isl_problema
    ADD CONSTRAINT fk_t_isl_id_veiculo FOREIGN KEY ( id_veiculo )
        REFERENCES t_isl_veiculo ( id_veiculo )ON DELETE CASCADE;
...
ALTER TABLE t_isl_prodiag
    ADD CONSTRAINT fk_t_isl_pre_diagnostico FOREIGN KEY ( t_isl_id_diagnostico )
        REFERENCES t_isl_pre_diagnostico ( id_diagnostico )ON DELETE CASCADE;

ALTER TABLE t_isl_prodiag
    ADD CONSTRAINT fk_t_isl_problema FOREIGN KEY ( t_isl_id_problema_prob,
                                                   t_isl_id_problema_vei )
        REFERENCES t_isl_problema ( id_problema,
                                    id_veiculo )ON DELETE CASCADE;

DROP SEQUENCE SEQ_ISL_CLIENTE;
DROP SEQUENCE SEQ_ISL_VEICULO;
DROP SEQUENCE SEQ_ISL_SERVICO;
DROP SEQUENCE SEQ_ISL_PECA;
DROP SEQUENCE SEQ_ISL_MECANICA;
DROP SEQUENCE SEQ_ISL_AVALIACAO;
DROP SEQUENCE SEQ_ISL_MARCA;
DROP SEQUENCE SEQ_ISL_PRE_DIAGNOSTICO;
DROP SEQUENCE SEQ_ISL_PROBLEMA;


CREATE SEQUENCE SEQ_ISL_CLIENTE
START WITH 1
INCREMENT BY 1
NOCACHE
NOCYCLE;

CREATE SEQUENCE SEQ_ISL_SERVICO
START WITH 1
INCREMENT BY 1
NOCACHE
NOCYCLE;
...
CREATE SEQUENCE SEQ_ISL_VEICULO
START WITH 1
INCREMENT BY 1
NOCACHE
NOCYCLE;

CREATE SEQUENCE SEQ_ISL_PECA
START WITH 1
INCREMENT BY 1
NOCACHE
NOCYCLE;

CREATE SEQUENCE SEQ_ISL_MECANICA
START WITH 1
INCREMENT BY 1
NOCACHE
NOCYCLE;

CREATE SEQUENCE SEQ_ISL_AVALIACAO
START WITH 1
INCREMENT BY 1
NOCACHE
NOCYCLE;

CREATE SEQUENCE SEQ_ISL_MARCA
START WITH 1
INCREMENT BY 1
NOCACHE
NOCYCLE;

CREATE SEQUENCE SEQ_ISL_PRE_DIAGNOSTICO
START WITH 1
INCREMENT BY 1
NOCACHE
NOCYCLE;

CREATE SEQUENCE SEQ_ISL_PROBLEMA
START WITH 1
INCREMENT BY 1
NOCACHE
NOCYCLE;
...
CREATE OR REPLACE TRIGGER TRIGGER_ISL_CLIENTE
BEFORE INSERT ON T_ISL_CLIENTE
FOR EACH ROW
BEGIN
    IF :NEW.id_cliente IS NULL THEN
        :NEW.id_cliente := SEQ_ISL_CLIENTE.NEXTVAL;
    END IF;
END;
/


CREATE OR REPLACE TRIGGER TRIGGER_ISL_VEICULO
BEFORE INSERT ON T_ISL_VEICULO
FOR EACH ROW
BEGIN
    IF :NEW.id_veiculo IS NULL THEN
        :NEW.id_veiculo := SEQ_ISL_VEICULO.NEXTVAL;
    END IF;
END;
/


CREATE OR REPLACE TRIGGER TRIGGER_ISL_SERVICO
BEFORE INSERT ON T_ISL_SERVICO
FOR EACH ROW
BEGIN
    IF :NEW.id_servico IS NULL THEN
        :NEW.id_servico := SEQ_ISL_SERVICO.NEXTVAL;
    END IF;
END;
/


CREATE OR REPLACE TRIGGER TRIGGER_ISL_PECA
BEFORE INSERT ON T_ISL_PECA
FOR EACH ROW
BEGIN
    IF :NEW.id_peca IS NULL THEN
        :NEW.id_peca := SEQ_ISL_PECA.NEXTVAL;
    END IF;
END;
/


CREATE OR REPLACE TRIGGER TRIGGER_ISL_MECANICA
BEFORE INSERT ON T_ISL_MECANICA
FOR EACH ROW
BEGIN
    IF :NEW.id_mecanica IS NULL THEN
        :NEW.id_mecanica := SEQ_ISL_MECANICA.NEXTVAL;
    END IF;
END;
/


CREATE OR REPLACE TRIGGER TRIGGER_ISL_AVALIACAO
BEFORE INSERT ON T_ISL_AVALIACAO
FOR EACH ROW
BEGIN
    IF :NEW.id_avaliacao IS NULL THEN
        :NEW.id_avaliacao := SEQ_ISL_AVALIACAO.NEXTVAL;
    END IF;
END;
/


CREATE OR REPLACE TRIGGER TRIGGER_ISL_MARCA
BEFORE INSERT ON T_ISL_MARCA
FOR EACH ROW
BEGIN
    IF :NEW.id_marca IS NULL THEN
        :NEW.id_marca := SEQ_ISL_MARCA.NEXTVAL;
    END IF;
END;
/


CREATE OR REPLACE TRIGGER TRIGGER_ISL_PRE_DIAGNOSTICO_TRIGGER
BEFORE INSERT ON T_ISL_PRE_DIAGNOSTICO
FOR EACH ROW
BEGIN
    IF :NEW.id_diagnostico IS NULL THEN
        :NEW.id_diagnostico := SEQ_ISL_PRE_DIAGNOSTICO.NEXTVAL;
    END IF;
END;
/


CREATE OR REPLACE TRIGGER TRIGGER_ISL_PROBLEMA_TRIGGER
BEFORE INSERT ON T_ISL_PROBLEMA
FOR EACH ROW
BEGIN
    IF :NEW.id_problema IS NULL THEN
        :NEW.id_problema := SEQ_ISL_PROBLEMA.NEXTVAL;
    END IF;
END;
/